<%@ Page Title="Repartidores" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminEmpleadosRepartidor.aspx.cs" Inherits="CapaPresentacionIntranet.AdminEmpleadosRepartidor" %>
        ...
        <div class="container">
            ...
            <%
                if (!IsPostBack)
                {
                    ...
                    {
                        Response.Write("<div class='alert alert-success alert-dismissible fade show' role='alert'>"+
                                       "La eliminacion se realizó exitosamente"+
                                       "<button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button></div>");
                    }
                }                          
             %>
            <div class="table-responsive text-center">
                <asp:GridView ID="GvEmpleadoRepartidor" runat="server" CssClass="table table-hover" OnSelectedIndexChanged="GvEmpleadoRepartidor_SelectedIndexChanged" OnRowDeleting="GvEmpleadoRepartidor_RowDeleting">
                    <Columns>
